...
fetch(`http://localhost:3000/api/teddies/${params.get('id')}`) //je met l'id du produit clické dans le fetch
    ...
    .then(data => {
          ...
          <span class="flex items-center">
            ...
            <a class="ml-2 text-gray-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                ...
                <div class="flex">
                    <span class="title-font font-medium text-2xl text-gray-900">${priceProd.toFixed(2)} €</span>
                    <button class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Ajouter au panier</button>
        ...
        /*let functionPrice = priceFunction(priceProd);
